...
# /Users/julis_478/Documents/Python Immersives/ PY-131- IT:Servers:Security:Networking/Lesson04 - Pytest/projectSpace - Julieth Ombita/IssLocation
...
class TestCalculatorMethods(unittest.TestCase):
    ...
    def test_add(self):
        self.assertEqual(
            self.calc.add(3, 3), 6, "tests addition of two arguments on integers"
        )
        self.assertEqual(
            self.calc.add(3, 3, 3), 9, "tests addition of three arguments on integers"
        )
